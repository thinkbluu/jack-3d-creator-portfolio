  ...
  return (
    <div className="flex flex-col items-center">
      <a
        ...
        className="cursor-pointer whitespace-nowrap rounded-[12px] bg-[var(--gold)] px-6 py-3 text-xs font-semibold uppercase tracking-[0.18em] text-[var(--bg)] shadow-[inset_0_1px_0_rgba(255,255,255,0.25)] transition-[filter,transform] hover:-translate-y-px hover:brightness-[1.06] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--gold-soft)] sm:px-8 sm:py-3.5"
      >
